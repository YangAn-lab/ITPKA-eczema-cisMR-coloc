...
gs = GridSpec(1, 2, width_ratios=[1.0, 1.45], wspace=0.32)
...
tbl_rows = [
    ...
    ["Skin cis-eQTL", "GTEx v8/v10 skin (SE+NSE)", "Absent; PP.H4 \u2264 0.21"],
    ["Skin RNA", "HPA / GTEx", "0.1 nTPM; 0.74\u20130.83 TPM"],
...
tbl = axb.table(cellText=[["Evidence layer", "Resource", "Result"]] + tbl_rows,
                colWidths=[0.30, 0.33, 0.42], loc='center', cellLoc='left')
